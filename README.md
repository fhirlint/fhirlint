...
docker run --rm -v $(pwd):/work ghcr.io/fhirlint/fhirlint:1.11.1 validate /work/fhir/
```
...
```yaml
- uses: fhirlint/fhirlint@v1.11.1
  with:
    path: ./fhir/
    fail-on: error
    severity: warning
...
```
Updates available:
  fhirlint   v1.11.0 → v1.11.1  https://github.com/fhirlint/fhirlint/releases
