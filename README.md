...
docker run --rm -v $(pwd):/work ghcr.io/fhirlint/fhirlint:1.10.0 validate /work/fhir/
```
...
```yaml
- uses: fhirlint/fhirlint@v1.10.0
  with:
    path: ./fhir/
    fail-on: error
    severity: warning
...
```
Updates available:
  fhirlint   v1.9.0 → v1.10.0   https://github.com/fhirlint/fhirlint/releases
