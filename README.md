...
docker run --rm -v $(pwd):/work ghcr.io/fhirlint/fhirlint:1.13.0 validate /work/fhir/
```
...
```yaml
- uses: fhirlint/fhirlint@v1.13.0
  with:
    path: ./fhir/
    fail-on: error
    severity: warning
...
```
Updates available:
  fhirlint   v1.12.1 → v1.13.0  https://github.com/fhirlint/fhirlint/releases
