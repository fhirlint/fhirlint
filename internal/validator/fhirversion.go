...
//
// R6 is absent on purpose. As of 2026-09-16 only half of it can be verified:
// hl7.fhir.r6.core — the package VersionUtilities.packageForVersion names — is
// on packages2.fhir.org as 6.0.0-snapshot1 (since 2026-09-10; packages.fhir.org
// still 404s), but tx.fhir.org answers /r4 and /r5 and 404s on /r6. A row
// added now would advertise a release whose terminology endpoint does not
